...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('./acorn.js')) : typeof define === 'function' && define.amd ? define(['exports', './acorn.js'], factory) : factory((global.acorn = global.acorn || {}, global.acorn.loose = global.acorn.loose || {}), global.acorn);
})(void 0, function (exports, acorn) {
  'use strict';

  var acorn__default = 'default' in acorn ? acorn['default'] : acorn; // Registered plugins
  ...
  lp.readToken = function () {
    ...
    for (;;) {
      try {
        ...
        if (this$1.toks.type === acorn.tokTypes.dot && this$1.input.substr(this$1.toks.end, 1) === "." && this$1.options.ecmaVersion >= 6) {
          this$1.toks.end++;
        ...
        if (replace) {
          if (this$1.options.locations) replace.loc = new acorn.SourceLocation(this$1.toks, acorn.getLineInfo(this$1.input, replace.start), acorn.getLineInfo(this$1.input, replace.end));
          return replace;
        }
      }
    }
  ...
  lp$1.parseStatement = function () {
    ...
    switch (starttype) {
      ...
      case acorn.tokTypes._return:
        this.next();
        if (this.eat(acorn.tokTypes.semi) || this.canInsertSemicolon()) node.argument = null;else {
  ...
  lp$1.parseClass = function (isStatement) {
    ...
    var node = this.startNode();
    this.next();
    if (this.tok.type === acorn.tokTypes.name) node.id = this.parseIdent();else if (isStatement) node.id = this.dummyIdent();else node.id = null;
    ...
    while (!this.closes(acorn.tokTypes.braceR, indent, line)) {
      ...
      if (method.key.type === "Identifier" && !method.computed && method.key.name === "static" && this$1.tok.type != acorn.tokTypes.parenL && this$1.tok.type != acorn.tokTypes.braceL) {
        method["static"] = true;
        isGenerator = this$1.eat(acorn.tokTypes.star);
        this$1.parsePropertyName(method);
      } else {
      ...
      if (this$1.options.ecmaVersion >= 5 && method.key.type === "Identifier" && !method.computed && (method.key.name === "get" || method.key.name === "set") && this$1.tok.type !== acorn.tokTypes.parenL && this$1.tok.type !== acorn.tokTypes.braceL) {
  ...
  lp$1.parseFunction = function (node, isStatement) {
    ...
    if (this.tok.type === acorn.tokTypes.name) node.id = this.parseIdent();else if (isStatement) node.id = this.dummyIdent();
  ...
  lp$2.parseObj = function () {
    ...
    while (!this.closes(acorn.tokTypes.braceR, indent, line)) {
      ...
      } else if (this$1.options.ecmaVersion >= 5 && prop.key.type === "Identifier" && !prop.computed && (prop.key.name === "get" || prop.key.name === "set") && this$1.tok.type != acorn.tokTypes.comma && this$1.tok.type != acorn.tokTypes.braceR) {
