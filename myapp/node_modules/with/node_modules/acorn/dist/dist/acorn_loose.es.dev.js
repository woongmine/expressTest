...
var _acorn = _interopRequireWildcard(require("./acorn.js"));
...
lp$2.parseSubscripts = function (base, start, noCalls, startIndent, line) {
  ...
  for (;;) {
    ...
    if (this$1.eat(_acorn.tokTypes.dot)) {
      ...
      var node$2 = this$1.startNodeAt(start);
      node$2.callee = base;
      node$2.arguments = this$1.parseExprList(_acorn.tokTypes.parenR);
...
lp$2.parseExprAtom = function () {
  ...
  switch (this.tok.type) {
    ...
    case _acorn.tokTypes.name:
      ...
      return this.eat(_acorn.tokTypes.arrow) ? this.parseArrowExpression(this.startNodeAt(start), [id]) : id;
...
_acorn["default"].LooseParser = LooseParser;
_acorn["default"].pluginsLoose = pluginsLoose;