...
function template(locals) {
  ...
  pug_mixins["form"] = pug_interp = function pug_interp(method, action) {
  ...
  pug_mixins["bar"] = pug_interp = function pug_interp() {
    var block = this && this.block,
        attributes = this && this.attributes || {};
  ...
  pug_mixins["foo"] = pug_interp = function pug_interp() {
  ...
  pug_mixins["baz"] = pug_interp = function pug_interp() {
    var block = this && this.block,
        attributes = this && this.attributes || {};
