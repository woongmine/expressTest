...
(function () {
  ...
  function B(n, t, r, e, u, o) {
    ...
    for (a = f; a--;) {
      var l = c[a];
      if (!(i ? l in t : pn.call(t, l))) return false;
    }

    var p = o.get(n),
        l = o.get(t);
    if (p && l) return p == t && l == n;
    ...
    return p && !i && (r = n.constructor, e = t.constructor, r != e && "constructor" in n && "constructor" in t && !(typeof r == "function" && r instanceof r && typeof e == "function" && e instanceof e) && (p = false)), p;
  }
  ...
  o.assignIn = Bn, o.before = G, o.bind = En, o.chain = function (n) {
    ...
    chain: false
  }), o.VERSION = "4.17.21", mn("pop join replace reverse split push shift sort splice unshift".split(" "), function (n) {
