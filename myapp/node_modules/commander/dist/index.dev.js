...
Command.prototype.option = function (flags, description, fn, defaultValue) {
  ...
  this.on(oname, function (val) {
    // coercion
    if (null !== val && fn) val = fn(val, undefined === self[name] ? defaultValue : self[name]); // unassigned or bool
...
Command.prototype.executeSubCommand = function (argv, args, unknown) {
  ...
  var baseDir,
      link = readlink(f); // when symbolink is relative path
  ...
  if (process.platform !== 'win32') {
    if (isExplicitJS) {
      args.unshift(localBin); // add executable arguments to spawn
