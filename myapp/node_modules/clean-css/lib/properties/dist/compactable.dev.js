...
var restore = require('./restore'); // Properties to process
...
var addFourValueShorthand = function addFourValueShorthand(prop, components, options) {
  options = options || {};
  compactable[prop] = {
...
addFourValueShorthand('margin', ['margin-top', 'margin-right', 'margin-bottom', 'margin-left']); // Adds `componentOf` field to all longhands
