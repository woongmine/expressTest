...
function merge(source, target) {
  for (var key in source) {
    ...
    if (_typeof(value) === 'object' && !util.isRegExp(value)) target[key] = merge(value, target[key] || {});else target[key] = key in target ? target[key] : value;
  }
...
function calculateSource(source) {
  if (_typeof(source) == 'object') return source;
