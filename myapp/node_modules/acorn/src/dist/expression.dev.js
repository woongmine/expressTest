...
pp.parseObj = function (isPattern, refDestructuringErrors) {
  ...
  while (!this.eat(_tokentype.types.braceR)) {
    ...
    if (!isPattern && this.options.ecmaVersion >= 8 && !isGenerator && !prop.computed && prop.key.type === "Identifier" && prop.key.name === "async" && this.type !== _tokentype.types.parenL && this.type !== _tokentype.types.colon && !this.canInsertSemicolon()) {
      isAsync = true;
