...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('./acorn')) : typeof define === 'function' && define.amd ? define(['exports', './acorn'], factory) : factory((global.acorn = global.acorn || {}, global.acorn.loose = global.acorn.loose || {}), global.acorn);
})(void 0, function (exports, __acorn) {
  'use strict'; // Registered plugins
  ...
  lp.readToken = function () {
    ...
    for (;;) {
      try {
        ...
        if (replace) {
          if (this$1.options.locations) replace.loc = new __acorn.SourceLocation(this$1.toks, __acorn.getLineInfo(this$1.input, replace.start), __acorn.getLineInfo(this$1.input, replace.end));
          return replace;
        }
      }
    }
  ...
  lp$1.parseStatement = function () {
    ...
    switch (starttype) {
      ...
      case __acorn.tokTypes._return:
        this.next();
        if (this.eat(__acorn.tokTypes.semi) || this.canInsertSemicolon()) node.argument = null;else {
  ...
  lp$1.parseClass = function (isStatement) {
    ...
    if (this.tok.type === __acorn.tokTypes.name) node.id = this.parseIdent();else if (isStatement) node.id = this.dummyIdent();else node.id = null;
  ...
  lp$1.parseFunction = function (node, isStatement, isAsync) {
    ...
    if (isStatement == null) isStatement = this.tok.type === __acorn.tokTypes.name;
    if (this.tok.type === __acorn.tokTypes.name) node.id = this.parseIdent();else if (isStatement) node.id = this.dummyIdent();
  ...
  lp$2.parseObj = function () {
    ...
    while (!this.closes(__acorn.tokTypes.braceR, indent, line)) {
      ...
      if (!prop.computed && prop.key.type === "Identifier" && prop.key.name === "async" && this$1.tok.type !== __acorn.tokTypes.parenL && this$1.tok.type !== __acorn.tokTypes.colon && !this$1.canInsertSemicolon()) {
        this$1.parsePropertyName(prop);
        isAsync = true;
      } else {
        isAsync = false;
      ...
      } else if (this$1.options.ecmaVersion >= 5 && prop.key.type === "Identifier" && !prop.computed && (prop.key.name === "get" || prop.key.name === "set") && this$1.tok.type != __acorn.tokTypes.comma && this$1.tok.type != __acorn.tokTypes.braceR) {
