...
module.exports = function runSymbolTests(t) {
  ...
  */
  ...
  t.equal(_typeof(Symbol.prototype.toString), 'function', 'Symbol#toString is a function'); // t.equal(String(foo), Symbol.prototype.toString.call(foo), 'Symbol#toString equals String of the same symbol');

  t.equal(_typeof(Object.getOwnPropertySymbols), 'function', 'Object.getOwnPropertySymbols is a function');
  var obj = {};
  var sym = Symbol('test');
  var symObj = Object(sym);
  t.notEqual(_typeof(sym), 'string', 'Symbol is not a string');
  ...
  var symVal = 42;
  obj[sym] = symVal; // eslint-disable-next-line no-restricted-syntax

  for (sym in obj) {
    t.fail('symbol property key was found in for..in of object');
  }
