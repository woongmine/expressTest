...
var requireResolveSupportsPaths = require.resolve.length > 1 && /^12\.[012]\./.test(process.version); // broken in v12.0-12.2, see https://github.com/nodejs/node/issues/27794
...
test('malformed package.json', function (t) {
  ...
  var res2 = resolve.sync('./index.js', {
    basedir: basedir,
    readPackageSync: function readPackageSync(readFileSync, pkgfile) {
